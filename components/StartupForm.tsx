  ...
  const handleFormSubmit =async (prevState: any, formData: FormData) => {
    try{
     //catching form values
      ...
      //parse and validate form values to schema 
      await formSchema.parseAsync(formValues);
      console.log("Form Values:", formValues);

      // Passing user inputs to the createPitch action - which write them in sanity db
  ...
  return (
    <form action={formAction} className='startup-form'>
      ...
      <div>
        ...
        <Input id="link" name='link' className='startup-form_input' required placeholder='Startup Image / Banner URL' />
